    ...
    <>
      <div className='flex justify-center mt-96'>
        <div className="relative w-96">
          ...
          <Link href={"/"}>
            <button onClick={() => {saveTextInLocalStorage()}} className="text-white absolute right-2.5 bottom-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">送信</button>
          </Link>
        </div>
        <p></p>
      </div>
